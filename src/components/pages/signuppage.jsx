            ...
            <div>
                ...
                <div className=' flex justify-center'>
                    ...
                    <div className=' ml-9 h-96 bg-white py-5 px-5 rounded-t-2xl hover:bg-green-300 flex justify-center mt-36 ease-in-out duration-1000 drop-shadow-md shadow-white'>
                        <h2 className='text-3xl font-mono p-2 bg-sky-400 text-center rounded-t-2xl pt-6 border-2 border-black w-72'>Register Here
                            <h1 className='text-sm text-center px-4 mt-9 '>
                                Welcome to the place where you want to connect with us.
                            </h1>
                            <img src={emoji} alt='emoji1' className='h-24 w-24 mt-6 ml-16'></img>
                        </h2>
                        <form onSubmit={handleSubmit}>
                            <div className=' hover:bg-yellow-200 w-72 rounded-xl p-9 h-72 ease-in-out duration-1000 '>
                                <div className='h-48'>
                                    ...
                                    <input className='w-44 h-8 rounded-3xl border-2 border-black pl-3 mb-3'
                                        type='firstname'
                                        id='firstname'
                                        value={firstname}
                                    ...
                                    <input className='w-44 h-8 rounded-3xl border-2 border-black pl-3'
                                        type='lastname'
                                        id='lastname'
                                        value={lastname}
                                    ...
                                    <br />
                                    <label className='font-mono text-s'> Email </label><br />
                                    <input className='w-44 h-8 rounded-3xl border-2 border-black pl-3'
                                        type='email'
                                        id='email'
                                        value={email}
                                    ...
                                    <label className='font-mono text-s'> Password </label><br />
                                    <input className='w-44 h-8 rounded-3xl border-2 border-black pl-3'
                                        type='password'
                                        id='password'
                                        value={password}
